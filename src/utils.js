...
export const fullRotation = Math.PI * 2;

// Half rotation
// in radians, handy to store these in readable variables
export const halfRotation = Math.PI;
...
export function mapAndClamp(value, low1, high1, low2, high2) {
  return clamp(map(value, low1, high1, low2, high2), Math.min(low2, high2), Math.max(low2, high2));
}
...
export function randomRoundNumber(min, max) {
